...
tl.fromTo(".service-item__img", 1, {opacity: 0, y: '70px'}, {opacity: 1, y: '0'})
  .fromTo(".service-item__title", 1, {opacity: 0, y: '70px'}, {opacity: 1, y: '0'})
  .fromTo(".service-item__desc", 1, {opacity: 0, y: '70px'}, {opacity: 1, y: '0'})
